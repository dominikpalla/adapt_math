...
\subsection{KNOWLEDGE\_WEIGHTS (76 vah, verze 260824)}
...
\begin{longtable}{p{4cm}rp{9.5cm}}
  ...
  SŠ                      & 6 & olivově žlutá \texttt{\#8d6e00} \\
...
\begin{itemize}
  \item \texttt{TASK\_CATEGORIES} (46) --- SŠ + Výroková logika + Funkce + Monotonie a extrémy + Konvexnost + Spojitost + Limita + Derivace + Průběh funkce + Primitivní funkce + Určitý integrál. Použito jako \emph{single-select} v UI: jedna primární kategorie úlohy.
...
Plný seznam 76 vah, seskupený dle prefixu. Pořadí v tabulce odpovídá pořadí ve zdrojovém kódu i v UI.
...
\begin{longtable}{p{1cm}p{6cm}p{8.5cm}}
  ...
  \multicolumn{3}{l}{\textit{SŠ (6)}} \\[2pt]
  ...
  36 & SŠ - Posloupnosti                       & Aritmetická / geometrická posloupnost, součty (2026-08-24). \\[4pt]
...
\paragraph{Dodatek 2026-08-24: +SŠ - Posloupnosti.} Krátce po v1.5 doplněna 46.~kategorie \emph{SŠ - Posloupnosti} (aritmetická / geometrická posloupnost, součty). Skupina SŠ tak roste z 5 na 6 položek, KNOWLEDGE\_WEIGHTS z 75 na 76, TASK\_CATEGORIES z 45 na 46. DB migrace není potřeba: jde jen o novou položku v dropdownu, žádná existující úloha se nepřepisuje.
...
\begin{enumerate}
  ...
  \item \textbf{Distribuce vah dle kategorie.} Definovat slovník \texttt{CATEGORY\_DEFAULT\_VECTOR}, který pro každou ze 45 kategorií předvyplní výchozí distribuci 76 vah. Při výběru kategorie v UI se předvyplní \texttt{knowledge\_vector}, expert pak ladí.
