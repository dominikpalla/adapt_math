...
\subsection{KNOWLEDGE\_WEIGHTS (79 vah, verze 260824)}
...
\begin{longtable}{p{4cm}rp{9.5cm}}
  ...
  SŠ                      & 8 & olivově žlutá \texttt{\#8d6e00} \\
  ...
  Derivace                & 8 & tmavě modrá \texttt{\#283593} \\
...
\begin{itemize}
  \item \texttt{TASK\_CATEGORIES} (49) --- SŠ + Výroková logika + Funkce + Monotonie a extrémy + Konvexnost + Spojitost + Limita + Derivace + Průběh funkce + Primitivní funkce + Určitý integrál. Použito jako \emph{single-select} v UI: jedna primární kategorie úlohy.
...
Plný seznam 79 vah, seskupený dle prefixu. Pořadí v tabulce odpovídá pořadí ve zdrojovém kódu i v UI.
...
\begin{longtable}{p{1cm}p{6cm}p{8.5cm}}
  ...
  \multicolumn{3}{l}{\textit{SŠ (8)}} \\[2pt]
  ...
  37 & SŠ - Množiny a relace                   & Operace s množinami, kartézský součin, relace, zobrazení (2026-08-24). \\
  38 & SŠ - Analytická geometrie               & Vektory, přímky, kuželosečky, vzdálenosti v $\mathbb{R}^2$ (2026-08-24). \\[4pt]
  ...
  \multicolumn{3}{l}{\textit{Derivace (8)}} \\[2pt]
  55 & Derivace - Definice                     & Použití definice derivace v bodě $f'(x_0) = \lim_{h \to 0}\frac{f(x_0+h)-f(x_0)}{h}$ (2026-09-03). \\
  56 & Derivace - Sčítání                      & Pravidlo $(f+g)' = f'+g'$. \\
  57 & Derivace - Součin                       & Pravidlo $(fg)' = f'g + fg'$. \\
  58 & Derivace - Podíl                        & Pravidlo $(f/g)' = (f'g-fg')/g^2$. \\
  59 & Derivace - Složená funkce               & Řetízkové pravidlo $(f \circ g)' = f'(g) \cdot g'$. \\
  60 & Derivace - Diferenciál                  & $df(x,h) = f'(x)\cdot h$; aproximace, odhady chyb. \\
  61 & Derivace - Taylorův polynom             & Taylorův / Maclaurinův polynom řádu $n$. \\
  62 & Derivace - Vyšší řády                   & $f^{(n)}$ a jejich výpočet. \\[4pt]

  \multicolumn{3}{l}{\textit{Průběh funkce (1)}} \\[2pt]
  63 & Průběh funkce                           & Komplexní vyšetření průběhu (D, parita, monotonie, …). \\[4pt]

  \multicolumn{3}{l}{\textit{Primitivní funkce (5)}} \\[2pt]
  64 & Primitivní funkce - Sčítání             & Linearita integrálu. \\
  65 & Primitivní funkce - Per partes          & $\int u\, dv = uv - \int v\, du$ pro neurčitý integrál. \\
  66 & Primitivní funkce - 1.věta o subustituci & $\int f(g(x)) g'(x)\, dx = \int f(t)\, dt$. \\
  67 & Primitivní funkce - 2.věta o substituci & Substituce $x = \varphi(t)$ (typicky s~odmocninou nebo exp.). \\
  68 & Primitivní funkce - Racionální funkce   & Rozklad racionální funkce, integrace (přejm. 2026-07-31). \\[4pt]

  \multicolumn{3}{l}{\textit{Určitý integrál (8)}} \\[2pt]
  69 & Určitý integrál - Sčítání               & Linearita určitého integrálu. \\
  70 & Určitý integrál - Aditivita             & $\int_a^c f = \int_a^b f + \int_b^c f$ pro $a<b<c$. \\
  71 & Určitý integrál - Per partes            & Per partes pro určitý integrál (s mezemi). \\
  72 & Určitý integrál - 1.věta o substituci   & První věta s úpravou mezí. \\
  73 & Určitý integrál - 2.věta o substituci   & Druhá věta s úpravou mezí. \\
  74 & Určitý integrál - Racionální funkce     & Racionální funkce v určitém integrálu (přejm. 2026-07-31). \\
  75 & Určitý integrál - Nevlastní             & Integrály s~nekonečnými mezemi nebo neomezenou funkcí. \\
  76 & Určitý integrál - Obsah plochy          & Výpočet obsahu rovinné oblasti ohraničené grafy funkcí. \\
  \bottomrule
\end{longtable}
...
\paragraph{Dodatek 2026-08-24: +3 SŠ kategorie.} Krátce po v1.5 doplněny další tři kategorie: \emph{SŠ - Posloupnosti} (aritmetická / geometrická posloupnost, součty), \emph{SŠ - Množiny a relace} (operace s množinami, kartézský součin, relace, zobrazení) a \emph{SŠ - Analytická geometrie} (vektory, přímky, kuželosečky, vzdálenosti v~$\mathbb{R}^2$). Skupina SŠ tak roste z 5 na 8 položek, KNOWLEDGE\_WEIGHTS z 75 na 78, TASK\_CATEGORIES z 45 na 48. DB migrace není potřeba: jde jen o nové položky v dropdownu, žádná existující úloha se nepřepisuje.

\paragraph{Dodatek 2026-09-03: +Derivace - Definice.} Doplněna 49.~kategorie \emph{Derivace - Definice} pro úlohy typu ,,použijte definici derivace v bodě $f'(x_0) = \lim_{h \to 0}\frac{f(x_0+h)-f(x_0)}{h}$'' (viz \texttt{umat\_09\_01..05}, které jsou dnes anotovány jako \emph{Derivace - Sčítání}, ale konceptuálně patří k definici). Skupina Derivace roste ze 7 na 8 položek, KNOWLEDGE\_WEIGHTS 78 $\rightarrow$ 79, TASK\_CATEGORIES 48 $\rightarrow$ 49. DB migrace není potřeba.

\paragraph{Dodatek 2026-09-03: fix \texttt{umat\_09\_36..39} (chybějící zadání).} Při extrakci UMAT skripta se ztratilo společné zadání LaTeX bloku \texttt{\textbackslash begin\{ul\}\{...\}}: úlohy \texttt{umat\_09\_36..39} zůstaly jen s fragmenty (,,tečna v bodě $T$ měla směrnici $k_t=1$;'' atd.) bez úvodní věty s funkcí. Doplněno kompletní zadání ,,Je dána funkce $y = x \cdot \ln x$. Určete bod $T$ grafu funkce tak, aby ..." + specifická podmínka. Fresh backup \texttt{adaptmath\_20260903\_114450.dump} před akcí.

\paragraph{Dodatek 2026-09-03: mazání 29 duplicit.} Detekce ve třech krocích: exact match na normalizovaném content\_latex + expected (\texttt{scripts/find\_umat\_duplicates.py} pro uvnitř zdrojů, \texttt{scripts/find\_cross\_source\_duplicates.py} pro cross-source), plán mazání s výběrem lépe anotovaného kandidáta (\texttt{scripts/plan\_delete\_duplicates.py}), side-by-side srovnání anotací (\texttt{scripts/compare\_duplicate\_annotations.py}). Cíl: mazat jen skutečně identické úlohy s jiným formátováním, ne stylistické série.

Nalezeno 27 EXACT skupin (56 úloh, obvykle po 2). U 26 z 27 měly obě strany kompletně vyplněné anotace, jen občas se rozcházely ve volbě \emph{Limita - VOAL (dosazení)} vs \emph{Limita - LVL (krácení)} u stejných úloh (dva různí anotátoři, různá klasifikace). Po konzultaci se rozhodlo ponechat UMAT verze (celé sekvence, konzistentní číslování) a smazat \texttt{cv} fragmenty.

Konkrétně smazáno 29 úloh (930 $\rightarrow$ 901):
\begin{itemize}
  \item Limity (24): \texttt{cv04\_08, cv04\_09, cv04\_16, cv04\_17}; \texttt{cv05\_05..09, cv05\_12..16, cv05\_19..25, cv05\_27..29}
  \item Integrál (1): \texttt{cv12\_30}
  \item Výroková logika (3): \texttt{e01\_12, e01\_13, e01\_15} (skupina 4 identických, zůstává \texttt{e01\_11})
  \item Elementární funkce (1): \texttt{ss07\_07}
\end{itemize}

Fuzzy match $\ge 0{,}97$ nalezl 13 dalších párů, ale 12 z nich byly \emph{stylistické série} (stejný template zadání s jinou funkcí, např.~\texttt{cv09\_07..20} pro monotonii $x^2 e^x, x e^{-x}, x^2 \ln x, ...$). Ty NEmazány. Backup \texttt{adaptmath\_20260903\_120845.dump} před akcí.
...
\begin{enumerate}
  ...
  \item \textbf{Distribuce vah dle kategorie.} Definovat slovník \texttt{CATEGORY\_DEFAULT\_VECTOR}, který pro každou ze 45 kategorií předvyplní výchozí distribuci 79 vah. Při výběru kategorie v UI se předvyplní \texttt{knowledge\_vector}, expert pak ladí.
