...
\subsection{KNOWLEDGE\_WEIGHTS (75 vah, verze 260824)}
...
Plný seznam 75 vah, seskupený dle prefixu. Pořadí v tabulce odpovídá pořadí ve zdrojovém kódu i v UI.
...
\begin{longtable}{p{1cm}p{6cm}p{8.5cm}}
  ...
  35 & SŠ - Soustavy rovnic                    & Lineární soustavy 2--3 neznámých (dosazovací / sčítací). \\[4pt]
...
\begin{enumerate}
  ...
  \item \textbf{Distribuce vah dle kategorie.} Definovat slovník \texttt{CATEGORY\_DEFAULT\_VECTOR}, který pro každou ze 45 kategorií předvyplní výchozí distribuci 75 vah. Při výběru kategorie v UI se předvyplní \texttt{knowledge\_vector}, expert pak ladí.
